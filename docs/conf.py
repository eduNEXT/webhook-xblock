...
"""
webhook-xblock documentation build configuration file.
...
project = 'webhook-xblock'
copyright = edx_theme.COPYRIGHT  # pylint: disable=redefined-builtin
author = edx_theme.AUTHOR
project_title = 'webhook-xblock'
...
html_context = {
    ...
    "github_repo": 'webhook-xblock',  # Repo name
...
#
# html_title = 'webhook-xblock v0.1.0'
...
texinfo_documents = [
    (top_level_doc, project_title, documentation_title,
     author, project_title, 'An X-block to send a payload with basic information about the course and student to a configurable URL.',
     'Miscellaneous'),
]
...
def on_init(app):  # pylint: disable=unused-argument
    ...
    check_call([apidoc_path, '-o', docs_path, os.path.join(root_path, 'webhook_xblock'),
                os.path.join(root_path, 'webhook_xblock/migrations')])
